...
function Hero() {
  return (
    <section className="relative min-h-screen overflow-hidden bg-black pt-40 pb-28">
      ...
      <div className="relative mx-auto flex max-w-7xl flex-col items-center px-6 text-center">
        ...
        <div className="mt-10 flex flex-col gap-4 sm:flex-row">
          ...
          <Link
            to="/contact"
            className="flex items-center justify-center gap-2 rounded-full bg-white px-7 py-3 font-medium text-black transition hover:scale-105"
          >
            Start Project
            <ArrowRight size={18} />
          </Link>
          ...
          <Link
            to="/projects"
            className="rounded-full border border-zinc-700 px-7 py-3 text-white transition hover:border-white"
          >
            View Projects
          </Link>
